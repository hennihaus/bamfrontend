...
const {value: hasPassed, handleBlur: handleHasPassedBlur} = useField<HasPassed>(
    "hasPassed",
    {},
...
const {value: minRequests, handleBlur: handleMinRequestsBlur} = useField<number>(
    "minRequests",
    {},
    {validateOnValueUpdate: false, type: "number"}
);
const {value: maxRequests, handleBlur: handleMaxRequestsBlur} = useField<number>(
    "maxRequests",
    {},
    {validateOnValueUpdate: false, type: "number"}
);
const {value: studentFirstname, handleBlur: handleStudentFirstnameBlur} = useField<string>(
    "studentFirstname",
    {},
    {validateOnValueUpdate: false, type: "text"}
);
const {value: studentLastname, handleBlur: handleStudentLastnameBlur} = useField<string>(
    "studentLastname",
    {},
    {validateOnValueUpdate: false, type: "text"}
);
