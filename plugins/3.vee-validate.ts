...
import {email, integer, max, max_value, min, min_value, required, url} from "@vee-validate/rules";
...
export default defineNuxtPlugin(({vueApp, $i18n}) => {
    ...
    const veeValidate = {
        install: () => {
            ...
            defineRule("unique_username", async (value: string, params: Record<string, any>) => {
                try {
            ...
            defineRule("unique_password", async (value: string, params: Record<string, any>) => {
                try {
            ...
            defineRule("unique_jms_queue", async (value: string, params: Record<string, any>) => {
                try {
            ...
            defineRule("unique_title", async (value: string, params: Record<string, any>) => {
                try {
